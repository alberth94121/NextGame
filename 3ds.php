		...
		<div class="container">		
			<div class="row">
				<div class="span12 cnt-title2" style="padding:20px" >
					...
					<h1  style="text-align: left;margin:20px">Upcoming Nintendo 3DS Games!<form   style="text-align: right" action="search.php?">
							<?php
			...
			<div class="row">	
				...
				<p class="nav">				
					<?php
						...
						if($page > 1){
							$p=$page-1;
							echo "<a  href='3ds.php?page=$p' class='button' >Prev </a>";
							echo '';
						}
						else{
						...
						if($pre >= 1+ $amt){
							$num = $pre-$amt;
							while($num < $pre){
								echo "<a href='3ds.php?page=$num' class='button' >$num </a>";
								echo '';
								$num+=1;
							}
						}
						...
						if($pre <= $total-$amt){
							$num = $pre+1;
							while($num <= $pre+$amt){
								echo "<a class='button'  href='3ds.php?page=".$num."'>$num </a>";
								echo '';
								$num+=1;
							}
						}
						...
						if($page < $total){
							$next=$page+1;
							echo "<a class='button'  href='3ds.php?page=".$next."'> Next</a>";
							echo '';
